import os
os.environ['TRANSFORMERS_NO_FLASH_ATTN'] = "1" #forbid flash-attention
...
class QueryReranker:
    ...
    def rerank(self, query: str, image_list: List[str]):
        """
        ...
        reason_match = re.search(r'<think>\[(.*?)\]</think>', output_text)
